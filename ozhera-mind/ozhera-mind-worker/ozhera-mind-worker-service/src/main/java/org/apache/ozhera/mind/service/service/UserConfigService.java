...
public interface UserConfigService {
    ...
    /**
     * Save or update current user's config (only one config per user)
     */
    UserConfig saveOrUpdate(UserConfig config);

    /**
     * Get current user's config
     */
    UserConfig getMyConfig();
    ...
    /**
     * Get config by username (for internal use)
     */
